...
function Posts({address,postId,businessName,descriptions,industry,location,ownerEmail,timestamp,ownerId,ownerUsername,ownerphotoURL,phone,postImage,location1}) {
    return (
        <div>
            {location1 === location  &&(
                <>
<ul class="search-results container" id="search-results-items"> 
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 results-display" itemscope itemtype="#">
                    ...
                    <span class="streetaddress" itemprop="address"> <a class="category" style={{color: "#000"}} title="Discover Car Hire in Car Hire" href={`/list-businesses-details/${ownerUsername}/${phone}/${ownerEmail}/${ownerId}/${businessName}/${descriptions}/${industry}/${address}/${location}/${auth?.currentUser?.uid}`}>
                                                                        <i class="fas fa-location-arrow"></i></a> 
                                                                                            <a class="link" href={`/list-businesses-details/${postId}/${ownerUsername}/${phone}/${ownerEmail}/${ownerId}/${businessName}/${descriptions}/${industry}/${auth?.currentUser?.uid}`} title="Car Hire in Avenue Motors premises opp Equity Bank, Moi Ave">{address}, {location}
                                                                                            </a> 
                                                                                        </span>
                                                                                        <div class="categorybiz"> 
                                                                                        <span>Category:</span> 
                                                                                        <a class="thecategory" data-value="1" data-business="Avenue Motors Ltd" data-catname="Car Hire" href={`/list-businesses-details/${ownerUsername}/${phone}/${ownerEmail}/${ownerId}/${businessName}/${descriptions}/${industry}/${address}/${location}/${auth?.currentUser?.uid}`} title="Car Hire">{industry}
                                                                                        </a>
                                                                                    </div>
...
<ul class="search-results container" id="search-results-items"> 
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 results-display" itemscope itemtype="#">
                    ...
                    <span class="streetaddress" itemprop="address"> <a class="category" style={{color: "#000"}} title="Discover Car Hire in Car Hire" href={`/list-businesses-details/${ownerUsername}/${phone}/${ownerEmail}/${ownerId}/${address}/${location}/${auth?.currentUser?.uid}`}>
                                                                        <i class="fas fa-location-arrow"></i></a> 
